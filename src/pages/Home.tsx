    ...
    <div className="grid grid-cols-1 gap-8 items-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-yellow-200 p-6 rounded-lg text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">Tailored Nutrition & Calories</h3>
          <p className="text-gray-700">Plan built for your body type — complete with tailored macros, calories & supplements to support optimal performance</p>
        </div>
        <div className="bg-yellow-200 p-6 rounded-lg text-center">
          <div className="mb-4">
            <span className="inline-block bg-black rounded-full p-2">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">Strength Training Progress</h3>
          <p className="text-gray-700">Every metric is tracked weekly / monthly to give you real-time data on your strength progress</p>
        </div>
        <div className="bg-black p-6 rounded-lg text-center">
          ...
          <h3 className="text-xl font-bold text-yellow-300 mb-2">Recovery</h3>
          <p className="text-yellow-300">Recovery routine designed to help your body fully recharge—so you can train harder, recover faster, and perform at your peak.</p>
        </div>
        <div className="bg-yellow-200 p-6 rounded-lg text-center">
          <div className="mb-4">
            <span className="inline-block bg-black rounded-full p-2">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">Steps & Cardio Vascular Endurance</h3>
          <p className="text-gray-700">Tailored step targets and cardio training to boost endurance, enhance fat loss, and improve cardiovascular health</p>
        </div>
        <div className="bg-yellow-200 p-6 rounded-lg text-center">
          <div className="mb-4">
            <span className="inline-block bg-black rounded-full p-2">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">Lifestyle Adjustments & Mindset</h3>
          <p className="text-gray-700">We refine your daily habits and strengthen your mindset to keep you disciplined, focused, and motivated throughout your transformation</p>
        </div>
      </div>
    </div>
  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div>
              ...
              <div className="flex justify-center mt-4 text-yellow-500">★★★★★</div>
            </div>
            <div>
              <p className="text-xl text-gray-600 italic">
