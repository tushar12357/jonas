  ...
  const services = [
    {
      ...
      description: "Dedicated one-on-one sessions with our expert trainers for maximum results.",
    ...
    },
    {
      ...
      description: "Train with friends in small groups while maintaining personalized attention.",
    ...
    },
    {
      ...
      description: "Comprehensive nutrition plans tailored to support your fitness goals.",
    ...
    <section id="personal-training" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12">
          <button className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-3 font-bold tracking-wider transition-colors duration-300">
            LEARN MORE
          </button>
        </div>
      </div>
