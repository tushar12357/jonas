  ...
  const features = [
    {
      ...
      description: "Our team consists of highly qualified and certified personal trainers with years of experience."
    },
    {
      icon: <Users className="w-12 h-12 text-yellow-400" />,
      title: "Personalized Approach",
      description: "Every program is tailored specifically to your goals, fitness level, and lifestyle."
    },
    {
      icon: <Target className="w-12 h-12 text-yellow-400" />,
      title: "Proven Results",
      description: "Our clients consistently achieve their fitness goals through our systematic approach."
    },
    {
      icon: <Clock className="w-12 h-12 text-yellow-400" />,
      title: "Flexible Scheduling",
      description: "Train when it works for you with our flexible scheduling options and online programs."
    }
  ];
